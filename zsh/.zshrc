# use .zshrc for interactive usage settings, e.g.,
# prompt,
...
export ZSH="/Users/arwhyte/.oh-my-zsh"
...
if [ -f ~/Development/repos/github/arwhyte/dotfiles/zsh/.aliases ]; then
    source ~/Development/repos/github/arwhyte/dotfiles/zsh/.aliases
else
    print "ERROR: ~/Development/repos/github/arwhyte/dotfiles/zsh/.aliases not found."
fi
